...
export const translations: Record<Language, TranslationDictionary> = {
  de: {
    ...
    data_export_full_desc: 'Exportiere deine gesamten Daten (Kabel, Ladegeräte, Geräte und Lagerorte) in eine lokale JSON-Datei zur Backup-Sicherung.',
    export_button: 'Exportieren (.json)',
    unassign_property: 'Zuordnung aufheben',
    new_value: 'Neuer Wert',
    connector_types: 'Stecker-Typen',
    standards_for: 'Standards für',
    privacy_policy: 'Datenschutzerklärung',
    privacy_policy_desc: 'Erfahre mehr über den lokalen Datenschutz und die Offline-Datenhaltung.',
    about_app: 'Über die App',
    layout_theme: 'Erscheinungsbild (Theme)',
    ...
    quick_create_and_link: 'Neues Element anlegen & verknüpfen',
    create_and_link: 'Erstellen & Verknüpfen',
  ...
  en: {
    ...
    cable_standards_grouped: 'Cable Standards (Grouped by Connector Type)',
    data_export: 'Data Export',
    data_export_desc: 'Download your entire inventory and location data as a local backup.',
    data_export_full_desc: 'Export all your data (cables, chargers, devices, and locations) to a local JSON file for backup.',
    export_button: 'Export (.json)',
    unassign_property: 'Unassign Property',
    new_value: 'New Value',
    connector_types: 'Connector Types',
    standards_for: 'Standards for',
    privacy_policy: 'Privacy Policy',
    privacy_policy_desc: 'Learn more about local privacy and offline data storage.',
    about_app: 'About the App',
    layout_theme: 'Appearance (Theme)',
    dark_mode: 'Dark Mode',
    ...
    quick_create_and_link: 'Create new item & link',
    create_and_link: 'Create & Link',
